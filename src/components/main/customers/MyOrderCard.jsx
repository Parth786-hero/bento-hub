...
export default function MyOrderCard({ created_at, products }) {
  ...
  // Extract only the hour (two digits)
  const formattedHour = orderDate.getHours().toString().padStart(2, "0");
    ...
    >
      ...
      >
        <div className="flex md:w-1/2 gap-2.5">
          ...
          <div>
            <h2 className="font-black text-[16px]">
              Arrived at {formattedHour} minutes
            </h2>
