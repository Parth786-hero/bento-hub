...
export default function CatDesign({ data, selected, onSelect }) {
  ...
  return (
    ...
    >
      <motion.div
        className="w-[90%] h-[65%] mx-auto p-1 rounded-2xl overflow-hidden flex items-center justify-center"
        animate={selected ? { rotate: 3 } : { rotate: 0 }}
      ...
      <motion.h2
        className={`${selected ? "font-extrabold tracking-wider" : ""} h-[35%] text-center text-[10.5px] tracking-wide rounded p-1 flex items-center justify-center`}
