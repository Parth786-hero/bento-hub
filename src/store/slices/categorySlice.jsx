...
export const fetchAllSubCategoryById = createAsyncThunk(
...
const categorySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchAllSubCategoryById.pending, (state) => {
        state.loading = true;
        state.error = null;
        // keep old data instead of clearing
      })
      .addCase(fetchAllSubCategoryById.fulfilled, (state, action) => {
        
        state.loading = false;
        state.error = null;
        state.data = action.payload.categories || action.payload;
      })
      .addCase(fetchAllSubCategoryById.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
        state.data = null;
      });
